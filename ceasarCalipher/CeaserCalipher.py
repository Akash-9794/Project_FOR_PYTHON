...
# Taking user input
text_ = input("Enter the secret message: ")
shift_ = int(input("Enter how many places to shift the letters: "))
...
if action.lower() == 'code':
    secret_code = caesar_cipher(text_, shift_)
    print(f"Here is your secret code: {secret_code}")
elif action.lower() == 'decode':
    decoded_message = caesar_cipher(text_, -shift_)  # Using a negative shift to decode
